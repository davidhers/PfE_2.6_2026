...
To the dataset the percentage point change of overweight people compared to the last datapoint is added. Since there is no percentage point change for the first datapoint, NA gets added there. This will be used for the last plot.
...
The income dataset is used in a similar way as the education levels dataset. A new data set gets created with data.frame, on the left again the provences, called "Regio", or region in english. Next to that the income of said provence divided by 1000 is there. 
