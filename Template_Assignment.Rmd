...
#A plot gets created with ggplot, which gets saved with ggsave. geom_line and geom_point are used to create a clear plot, with scale_x_continuous the x axis values get determined.
```
