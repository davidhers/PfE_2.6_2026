...
```{r}
#the following lines of code make the lines and the plot.
perc_over_time_plot = ggplot() +
  ...
  geom_point(aes(x = perc_overgewicht[[1]],
                 y = perc_overgewicht[[3]])) +
  #The remaining code in this chunk defines the layout of the graph. This includes x and y-axis and the labels.
...
The graph reveals that the percentage of overweight/obese people has increased at a relatively constant rate over time, with the exception of a larger increase between 1995 and 2000.
...
plot_men_vs_women <- ggplot() +
  ...
  geom_point(aes(x= perc_overgewicht[[1]],
              y = perc_overgewicht[[5]]))  +
  #the following lines of code change the colors of the lines in the graph. 
  scale_color_manual( values = c("Overweight" = "black",
                                 "Men" = "blue",
                                 "Women" = "deeppink")) +
  #The last lines of code in this chunk define the layout of the graph. This includes x and y-axis and the labels.
  scale_x_continuous(breaks = seq(1980, 2025, by = 5)) +
  ylim(0,50) +
...
```{r analysis}
#the following lines of code make the lines and the plot, including a vertical line at the time of the event.
plot_event <- ggplot() +
  geom_line(aes(x = perc_overgewicht[[1]],
                y = perc_overgewicht[[2]],
                color = "Overgewicht")) +
  ...
  geom_vline(xintercept = 2005, linetype = "dashed")+
   # The remaining code in this chunk defines the layout of the graph. This includes x and y-axis, the text inside the graph and the labels.
